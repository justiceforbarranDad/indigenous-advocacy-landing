...
- [x] Test QR code scanning on mobile devices - QR codes working
- [x] Verify Stripe payments go directly to user account - Multiple payment methods integrated
