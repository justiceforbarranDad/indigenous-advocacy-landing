...
export function SilenceClock() {
  ...
  return (
    <div className="silence-clock-container bg-black/90 border-4 border-red-600 rounded-xl p-8 text-center max-w-2xl mx-auto shadow-2xl">
      <h3 className="text-white text-3xl font-bold mb-6 tracking-widest uppercase">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-red-600 rounded-lg p-4">
          <div className="text-white text-5xl font-bold font-mono tracking-tight">
            {time.days}
          </div>
          <p className="text-white text-sm font-semibold mt-2 uppercase">
        ...
        {/* Seconds */}
        <div className="bg-red-600 rounded-lg p-4">
          <div className="text-white text-5xl font-bold font-mono tracking-tight animate-pulse">
