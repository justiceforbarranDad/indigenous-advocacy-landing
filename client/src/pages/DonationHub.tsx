...
export default function DonationHub() {
  ...
  const translations = {
    ...
    ht: {
      ...
      donate: 'Bay',
      secure: 'Peman sekirize pa Stripe',
      impact: 'Enpak ou',
      impacts: [
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-3">
            {t.impacts.map((item) => (
              <div key={item.amount} className="flex items-center gap-4 p-3 bg-gray-700/30 rounded-lg">
                <span className="text-red-500 font-bold text-lg min-w-fit">${item.amount}</span>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 mb-4">Or scan to donate:</p>
          <img
