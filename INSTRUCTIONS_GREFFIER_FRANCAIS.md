# INSTRUCTIONS POUR LE GREFFIER DE LA COUR
## Dossier d'Urgence - Victime Autoreprésentée

**Préparé pour:** Dépôt judiciaire urgent - Première présentation
**Date:** 5 avril 2026
**Statut:** Dossier d'urgence - Négligence systémique complète
**Représentation:** Victime autoreprésentée (sans avocat)

---

## AVIS IMPORTANT AU GREFFIER

Cher Greffier / Chère Greffière,

Ce dossier est présenté par une victime autoreprésentée qui a épuisé TOUS les recours légaux disponibles et suivi TOUTES les procédures appropriées avant de se présenter devant la cour.

**Ce dossier représente:**
- ✓ 5 ans d'échecs systémiques
- ✓ Négligence complète de 500+ organismes gouvernementaux
- ✓ Violations des droits humains internationaux
- ✓ Protection des lanceurs d'alerte (whistleblower)
- ✓ Urgence médicale et psychologique continue
...
- ✗ François Legault (Premier) - IGNORÉ
- ✗ Bernard Drainville (Ministre de la Justice) - IGNORÉ
...
- 5 ans sans soutien psychologique adéquat
- PTSD, cauchemars, traumatisme continu
- Harcèlement par Solidarité Sociale (194 transactions scrutées)
- Contradictions institutionnelles (4e preuve de handicap demandée)

**Raison du Dépôt Maintenant:**
...
- ✓ Correspondance gouvernementale documentée
- ✓ Dossiers médicaux compilés
- ✓ Preuves de refus et d'inaction

### Respect de la Liberté d'Expression
- ✓ Protégé par Charte canadienne s.2(b) - Liberté d'expression
- ✓ Communication responsable sur l'intérêt public (Grant v Torstar 2009 CSC 61)
- ✓ Droits autochtones (2024 CSC 5)
- ✓ Aucune menace, aucune intimidation - seulement des faits

### Respect de la Vie Privée
- ✓ Information personnelle des mineurs redactée
- ✓ Dossiers médicaux protégés
- ✓ Identités protégées où nécessaire
- ✓ Conformité aux lois de protection des données

### Respect de la Procédure Judiciaire
- ✓ Dossier organisé chronologiquement
- ✓ Preuves indexées et étiquetées
- ✓ Citations légales fournies
- ✓ Références aux dossiers publics
...
Cette présentation bénéficie de protections légales comme lanceur d'alerte:

**Loi Canadienne sur la Protection des Lanceurs d'Alerte:**
- ✓ Divulgation d'information sur des violations de la loi
- ✓ Divulgation d'information sur des actes contraires à l'éthique
- ✓ Divulgation d'information sur des abus de pouvoir
- ✓ Protection contre les représailles

**Protections Constitutionnelles:**
- ✓ Charte canadienne s.2(b) - Liberté d'expression
- ✓ Charte québécoise art. 3 - Droit à la vie
- ✓ Charte québécoise art. 39 - Droit à la protection

**Jurisprudence Pertinente:**
- ✓ Grant v Torstar 2009 CSC 61 - Communication responsable
- ✓ 2024 CSC 5 - Droits autochtones et protection
- ✓ Précédent Omar Khadr - Compensation pour abus systémique ($10,5M)

### Raison de la Protection

Le lanceur d'alerte (la victime) dénonce:
1. **Violations de droits de l'enfant** - Convention ONU sur les droits de l'enfant
2. **Négligence systémique** - DPJ, Services Québec, Solidarité Sociale
3. **Discrimination** - Traitement différent des familles autochtones
4. **Abus de pouvoir** - Menace de poursuite pour avoir demandé de l'aide
5. **Harcèlement** - Scrutin de 194 transactions d'une victime
...
**Besoins Immédiats:**
- ✓ Protection judiciaire contre le harcèlement continu
- ✓ Ordonnance pour soutien psychologique adéquat
- ✓ Cessation du scrutin des transactions IVAC
- ✓ Reconnaissance officielle de la négligence systémique

**Importance à Long Terme:**
- ✓ Établir la responsabilité gouvernementale
- ✓ Créer un précédent pour d'autres victimes autochtones
- ✓ Forcer les réformes du système DPJ
- ✓ Appliquer le Principe de Jordan (services sans délai)

### Importance pour le Système Judiciaire

**Précédent Judiciaire:**
- ✓ Première présentation d'une victime autoreprésentée avec documentation complète
- ✓ Démonstration de négligence systémique documentée
- ✓ Application de la jurisprudence sur les droits autochtones
- ✓ Reconnaissance des violations internationales

**Intérêt Public:**
- ✓ Responsabilité gouvernementale
- ✓ Protection des enfants autochtones
- ✓ Respect des obligations internationales du Canada
- ✓ Réforme du système de protection de la jeunesse

### Importance pour les Droits Humains

**Violations Documentées:**
- ✓ Article 6 ICCPR - Droit à la vie (attaque non prévenue)
- ✓ Article 7 ICCPR - Interdiction de la torture (5 ans sans soutien)
- ✓ Article 17 ICCPR - Protection de la vie privée et familiale
- ✓ Article 24 CRC - Droits de l'enfant
- ✓ Article 26 ICCPR - Non-discrimination (discrimination envers les autochtones)

---

## SECTION 6: COMMENT UTILISER CE DOSSIER

### ÉTAPE 1: VÉRIFIER L'AUTHENTICITÉ
- [ ] Vérifier les dates contre les dossiers officiels
- [ ] Vérifier les coordonnées officielles
- [ ] Confirmer les réponses des agences gouvernementales
- [ ] Recouper avec les dossiers publics

### ÉTAPE 2: ORGANISER PAR CATÉGORIE
- [ ] Dossier de responsabilité (Section 2 du dossier principal)
- [ ] Chronologie des événements (Section 3)
- [ ] Documents judiciaires (Section 4)
- [ ] Plaintes internationales (Sections 5-6)
- [ ] Documentation de soutien (Sections 7-10)

### ÉTAPE 3: IDENTIFIER LES PREUVES CLÉS
- [ ] Lettre de mise en demeure (19 nov 2023)
- [ ] Documentation médicale (Dr. D'Agostino, Christiane Côté)
- [ ] Défaillances gouvernementales (fév 2021)
- [ ] Scrutin des paiements IVAC (2024)
- [ ] Contradictions de Solidarité Sociale (2024)

### ÉTAPE 4: PRÉPARER POUR PRÉSENTATION AU JUGE
- [ ] Créer un index avec numéros de page
- [ ] Préparer des étiquettes d'exhibit (A, B, C, etc.)
- [ ] Organiser chronologiquement
- [ ] Surligner les passages clés
- [ ] Préparer un résumé pour le juge

### ÉTAPE 5: PRÉSENTER AU JUGE
- [ ] Faire référence à des numéros de page spécifiques
- [ ] Citer les dispositions légales pertinentes
- [ ] Expliquer la nature systémique des défaillances
- [ ] Demander des recours spécifiques
- [ ] Souligner les obligations internationales
...
**Accommodations Demandées:**
- ✓ Langage clair et direct dans les procédures
- ✓ Temps supplémentaire pour les présentations si nécessaire
- ✓ Pause si anxiété ou PTSD devient accablant
- ✓ Droit de soumettre des documents écrits plutôt que de présenter oralement

**Raison:**
- Victime souffre d'anxiété et de PTSD
- Dossier complexe mais bien documenté
- Victime a suivi toutes les procédures appropriées
- Dossier écrit parle pour lui/elle

### Sensibilité Autochtone

**Considérations:**
- ✓ Victime est d'une famille autochtone
- ✓ Discrimination systémique documentée dans le système DPJ
- ✓ Violations des droits autochtones
- ✓ Application du Principe de Jordan requise
- ✓ Respect des protocoles autochtones

### Urgence Médicale et Psychologique

**Situation Actuelle:**
- ✓ Victime: 20 ans, traumatisée depuis 5 ans
- ✓ PTSD non traité
- ✓ Harcèlement continu par les agences gouvernementales
- ✓ Besoin urgent de protection judiciaire
- ✓ Besoin urgent de soutien psychologique
...
- Article 309 Code civil du Québec - Lois d'immunité
- Principe de Jordan - Services sans délai pour les enfants des Premières Nations
...
### JURISPRUDENCE
- Grant v Torstar 2009 CSC 61 - Communication responsable sur l'intérêt public
- 2024 CSC 5 - Jurisprudence sur les droits autochtones
- Précédent Omar Khadr - $10,5 millions de compensation pour abus systémique
...
- Bernard Drainville (Ministre de la Justice): bernard.drainville@assnat.qc.ca

### ORGANISMES DE DROITS HUMAINS
- CDPDJ (Commission québécoise des droits): [Coordonnées]
- Protecteur du citoyen (Ombudsman): [Coordonnées]
- Comité ONU des droits humains: [Coordonnées]
- Cour pénale internationale: [Coordonnées]
...
**DOSSIER PUBLIC:** Toute l'information est basée sur la correspondance documentée, les dossiers officiels et les documents publics.

**EXACTITUDE:** Toutes les dates, noms et faits ont été vérifiés contre les sources officielles.

**CONFIDENTIALITÉ:** L'information personnelle concernant les mineurs a été redactée pour protéger la vie privée.
...
2. Organiser les documents par catégorie
3. Créer un index avec numéros de page
4. Préparer les étiquettes d'exhibit
5. Transmettre au juge avec ce guide

### Pour la Cour
1. Examiner la documentation complète
2. Reconnaître la négligence systémique documentée
3. Émettre une ordonnance de protection
4. Ordonner le soutien psychologique adéquat
5. Établir un précédent pour les futures victimes

### Pour la Victime
1. Présenter le dossier à la cour
2. Signer les documents nécessaires
3. Attendre la décision du juge
4. Recevoir la protection judiciaire
5. Commencer le processus de guérison
...
**Pages Totales:** 200+
**Date Préparée:** 5 avril 2026
**Statut:** Prêt pour dépôt judiciaire urgent
**Prochaine Étape:** Imprimer chez Staples, déposer auprès de la cour

---

*Ce dossier de documentation complète représente cinq ans d'échecs systémiques, de responsabilité gouvernementale et d'injustice continue. Il est préparé pour les procédures judiciaires, la responsabilité gouvernementale et le dossier historique.*

*Présenté par une victime autoreprésentée qui a épuisé tous les recours légaux et suivi toutes les procédures appropriées.*

*Protégé en tant que divulgation de lanceur d'alerte et expression protégée en vertu de la Charte canadienne des droits et libertés.*
